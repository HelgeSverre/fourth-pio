...
An experiment in concatenative PIO programming. A tiny Forth interpreter (~1,150 lines of C) where RP2040 PIO instructions are structured data on a stack, not packed integers.
